...
def parse_args():
    ...
    parser.add_argument('--prompt-variant', type=str, default='default',
                       ...
                       help='Prompt variant to use (default: original, explore: explore-first, guided: light guidance + validator, guided_memory: guided + working memory, harness_v1: guided + working memory + compacted tool schema, harness_v2: harness_v1 + constraint extraction, harness_v3: harness_v2 + LLM-generated OR-Tools solver, harness_v4: harness_v2 + fixed CP-SAT template solver, harness_v5: LLM picks entities + CP-SAT intra-day scheduler)')
